...
class TripleScoring(torch.nn.Module):
    def __init__(self, base_model='albert-base-v2', path=None, max_len=80, sep='<eos>'):
        ...
        if path:
            ...
            #Path("src/model_transformers/models/baseline-2022-04-09" + 
            model_path = Path("src/model_transformer/models/baseline-2022-12-09" + '/candidate_scorer_' + base_model + '.zip')
