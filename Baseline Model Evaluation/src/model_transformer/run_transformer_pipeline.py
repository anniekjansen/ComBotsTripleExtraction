...
class AlbertTripleExtractor:
    def __init__(self, path, base_model='albert-base-v2',
    ...
    def extract_triples(self, dialog, post_process=True, batch_size=32, verbose=True, ):
        ...
        pred_args = bio_tags_to_tokens(subwords, preds.T, one_hot=True)  # change predicate to True
...
if __name__ == '__main__':
    ...
    model = AlbertTripleExtractor('models/2022-04-27')
